    ...
    <div class="container-fluid container-xxl d-flex align-items-center d-content-lg-between justify-content-between ">
      ...
      <nav id="navbar" class="navbar order-last order-lg-0">
        <ul>
          ...
          <li>
            <a class="nav-link scrollto cartbadge position-relative"  href="{{route('order.index')}}">
              <i class="bi bi-cart3 cartbadge fs-5"  value="0"></i>
        ...
        <!-- bage add -->
        <span class="position-absolute top-2 start-100 translate-middle p-1  bg-danger border border-light rounded-circle cartbadge " id="cartbadge">
