    ...
    <div class="container-fluid container-xxl d-flex align-items-center d-content-lg-between justify-content-between ">
      ...
      <nav id="navbar" class="navbar order-last order-lg-0">
        <ul>
          ...
          <li><a class="nav-link scrollto" href="{{url('/special')}}">Specials</a></li>
          ...
          <li><a class="nav-link scrollto" href="{{url('/cart')}}"><svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" class="bi bi-cart-plus-fill" viewBox="0 0 16 16">
